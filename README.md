...
# Dataset Strategy
Here is a table summarizing the datasets used to train RoboCat:

| Dataset | Type | # Images | Domain | Link |
|-|-|-|-|-|  
| ImageNet | Image classification| 14M+ | Generic images | https://image-net.org/ |
| Meta-World | Robotic manipulation | - | 3D simulation | https://meta-world.github.io/ |
| DM Control Suite | Control tasks | - | 3D simulation | https://github.com/deepmind/dm_control |  
| Sawyer domain randomised stacking | Robotic stacking | - | 3D simulation | From (Lee et al., 2021) |
| Sawyer real red-on-blue stacking | Robotic stacking  | - | Real robot | From (Lee et al., 2021) | 
| Panda simulated stacking | Robotic stacking | - | 3D simulation | Collected for this work |
| Panda real stacking | Robotic stacking | - | Real robot | Collected for this work|
| Simulated NIST-i | Robotic manipulation | - | 3D simulation | Collected for this work|  
| Real NIST-i | Robotic manipulation | - | Real robot | Collected for this work|
| Simulated YCB fruit lifting | Robotic manipulation | - | 3D simulation | Collected for this work|
| Real YCB fruit/vegetable lifting | Robotic manipulation | - | Real robot | Collected for this work|
| Real robot demos | Robotic manipulation | - | Real robot | Collected via human teleoperation for this work|
| Self-generated data | Robotic manipulation | - | Real robot | Collected by RoboCat agents for this work|

The key points are:
- They use a combination of public datasets like ImageNet and task-specific datasets collected for this work. 
- The robotic manipulation datasets are a mix of simulated and real world data.
- The real world datasets come from human demonstrations, RL agents running on the real robots, and data generated by the RoboCat agents themselves.
